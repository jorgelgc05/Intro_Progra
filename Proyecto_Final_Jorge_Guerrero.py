...
def dibujar_medidor(imc, frame):
    ...
    # Relación de aspecto igual asegura que el gráfico se dibuje como un círculo.
...
# Función para establecer un marcador de posición en un campo de entrada
...
# Función para limpiar el marcador de posición
def clear_placeholder(event, placeholder):
    if event.widget.get() == placeholder:
        event.widget.delete(0, tk.END)
        event.widget.config(fg='black')

# Función para añadir el marcador de posición si el campo está vacío
